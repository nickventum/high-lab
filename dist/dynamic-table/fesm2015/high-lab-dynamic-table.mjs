...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: DataTableCellDirective, decorators: [{
        ...
        return [{ type: i0.ViewContainerRef }, { type: i0.ComponentFactoryResolver }, { type: Map, decorators: [{
                        type: Inject,
...
class DynamicTableQueryParamsModel extends StrictModel {
    constructor(options, mapping, defaultValues) {
        var _a, _b, _c;
        super({
            page: (_a = options[mapping.page]) !== null && _a !== void 0 ? _a : defaultValues.page,
            pageSize: (_b = options[mapping.pageSize]) !== null && _b !== void 0 ? _b : defaultValues.pageSize,
            sort: (_c = options[mapping.sort]) !== null && _c !== void 0 ? _c : defaultValues.sort,
        }, false);
...
class DynamicTableComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.updateRouterQueryParams(true, true);
    ...
    getDefaultQueryParams() {
        var _a, _b;
        const defaultSort = (_a = this.table.find(v => v.defaultSort)) === null || _a === void 0 ? void 0 : _a.key;
        const firstSort = (_b = this.table.find(v => v.sort)) === null || _b === void 0 ? void 0 : _b.key;
    ...
    updateRouterQueryParams(replaceUrl = true, emitEvent = false) {
        const allQueryParams = Object.assign({}, this.activatedRoute.snapshot.queryParams);
        ...
        return this.router.navigate(['./'], {
            replaceUrl,
            queryParams: Object.assign(Object.assign({}, allQueryParams), newQueryParams),
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: DynamicTableComponent, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.ChangeDetectorRef }, { type: i1.Router }, { type: i1.ActivatedRoute }, { type: Map, decorators: [{
                        type: Inject,
                        args: [DATA_TABLE_CONFIG_MAP]
                    }] }];
