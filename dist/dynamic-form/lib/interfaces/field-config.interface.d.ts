...
declare type RelatedFieldsCheckVisibilityFunction = (currentValue: any, prevValue: any, control: ExtendedControls) => boolean;
declare type RelatedFieldsConfigFunction = (currentValue: any, prevValue: any, control: ExtendedControls) => AbstractField[];
