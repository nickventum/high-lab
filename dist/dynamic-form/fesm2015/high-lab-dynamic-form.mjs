...
class ExtendedFormGroup extends FormGroup {
    ...
    patchValue(value, options = {}) {
        ...
        Object.keys(value).forEach(name => {
            if (this.controls[name]) {
                this.controls[name].patchValue(value[name], Object.assign(Object.assign({}, options), { onlySelf: true }));
            }
        });
    ...
    resetToDefaultValue(options = {}) {
        Object.values(this.controls).forEach(control => control.resetToDefaultValue(Object.assign(Object.assign({}, options), { onlySelf: true })));
...
class ExtendedFormArray extends FormArray {
    ...
    patchValue(value, options = {}) {
        ...
        value.forEach(((newValue, index) => {
            if (this.at(index)) {
                this.at(index).patchValue(newValue, Object.assign(Object.assign({}, options), { onlySelf: true }));
            }
        }));
        this.updateValueAndValidity(options);
        this.lastPatchedValue = value;
    ...
    resetToDefaultValue(options = {}) {
        ...
        if (Array.isArray(this.lastPatchedValue)) {
            ...
            this.controls.forEach((control, index) => {
                control.patchValue(this.lastPatchedValue[index], Object.assign({ onlySelf: true, useAsDefault: true }, options));
            });
            this.updateValueAndValidity({ onlySelf: true });
        }
    }
...
class BaseFieldComponent {
    ...
    get hasTemplateRef() {
        var _a;
        return !!this.template && (this.template instanceof TemplateRef || ((_a = this.template) === null || _a === void 0 ? void 0 : _a.ref) instanceof TemplateRef);
    }
    get templateRef() {
        var _a, _b;
        ...
        else if (((_a = this.template) === null || _a === void 0 ? void 0 : _a.ref) instanceof TemplateRef) {
            return (_b = this.template) === null || _b === void 0 ? void 0 : _b.ref;
        }
        return null;
    }
